...
class FileSubmission(models.Model): 
	# test 
	# job = models.ForeignKey('user.CreateJob', null=False, blank=False, on_delete=models.CASCADE)
	user = models.ForeignKey(Account, null = False, blank = False, on_delete = models.CASCADE, related_name = "user_fileSumission")
	job = models.ForeignKey(CreateJob, null=False, blank=False, related_name="job_fileSumission", on_delete=models.CASCADE)
	file_upload = models.FileField(upload_to=filepath) # for creating file input 
	...
	job_objective = models.CharField(max_length=70, null=True,blank=True)
	bdate = models.CharField(max_length=70, null=True,blank=True)
	class Meta:  
		db_table = "FileSubmission"

class WorkExperience(models.Model):
	user = models.ForeignKey(Account, null=False, blank=False, related_name="user_workExperience", on_delete=models.CASCADE)
	job = models.ForeignKey(CreateJob, null=False, blank=False, related_name="job_workExperience", on_delete=models.CASCADE)
	title = models.CharField(max_length=70, null=True,blank=True)
	companyAdd = models.CharField(max_length=70, null=True,blank=True)
	work_year = models.CharField(max_length=70, null=True,blank=True)
	work_achievements = models.CharField(max_length=70, null=True,blank=True)

	class Meta:
		db_table = "WorkExperience"

class Education(models.Model):
	user = models.ForeignKey(Account, null=False, blank=False, related_name="user_education", on_delete=models.CASCADE)
	job = models.ForeignKey(CreateJob, null=False, blank=False, related_name="job_education", on_delete=models.CASCADE)
	education = models.CharField(max_length=70, null=True,blank=True)
	educ_year = models.CharField(max_length=70, null=True,blank=True)
	course_taken = models.CharField(max_length=70, null=True,blank=True)
	educ_achievements = models.CharField(max_length=70, null=True,blank=True)

	class Meta:
		db_table = "Education"

class Skills(models.Model):
	user = models.ForeignKey(Account, null=False, blank=False, related_name="user_skills", on_delete=models.CASCADE)
	job = models.ForeignKey(CreateJob, null=False, blank=False, related_name="job_skills", on_delete=models.CASCADE)
